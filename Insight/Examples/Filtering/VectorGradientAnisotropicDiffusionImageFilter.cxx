/*=========================================================================
  ...
  Module:    $RCSfile: VectorGradientAnisotropicDiffusionImageFilter.cxx,v $
  Language:  C++
  Date:      $Date: 2005/08/27 01:46:05 $
...
int main( int argc, char * argv[] )
{
  ...
  //  $5$, more iterations will result in further smoothing and will 
