...
#set image [image create picture -file /home/gah/wood_abstract.gif] 
#set normalBg [blt::bgstyle create picture -picture $image]
#set normalBg [blt::bgstyle create texture -high grey95 -low grey90]
#set activeBg [blt::bgstyle create texture -high red1 -low red2]
set normalBg grey80
set normalBg grey80
set activeBg grey70
...
blt::tile::frame .f1 -bg $normalBg
blt::tile::frame .f2 -bg $normalBg
