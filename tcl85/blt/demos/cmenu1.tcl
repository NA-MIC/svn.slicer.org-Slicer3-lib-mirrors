...
set bg [blt::bgstyle create gradient -low  grey100 -high grey90 \
...
blt::tile::scrollbar .e.m.xbar -orient horizontal -command { .e.m xview } \
    -width 17
# -elementborderwidth 2 -borderwidth 0
blt::tile::scrollbar .e.m.ybar -orient vertical -command { .e.m yview } \
...
.e.m item configure Undo -type command -image $icon2 
.e.m item configure Cut -type command 
.e.m item configure Find -type cascade -menu .e.m.m
#-state disabled
.e.m item configure Y3 -type command 
.e.m item configure Undo -type command 
.e.m item configure Paste -type separator 
.e.m item configure x -state disabled 
.e.m item configure y -type radiobutton -variable wwho 
...
blt::tile::scrollbar .e.m.m.xbar -orient horizontal -command { .e.m.m xview } \
    -width 17
# -elementborderwidth 2 -borderwidth 0
blt::tile::scrollbar .e.m.m.ybar -orient vertical -command { .e.m.m yview } \
    -highlightthickness 0 -width 17 
#-elementborderwidth 2 -borderwidth 0
...
.e.m.m item configure y -type radiobutton -variable wwho 
...
blt::tile::scrollbar .e.m.m.m.xbar  \
    -orient horizontal \
    -command { .e.m.m.m xview } \
    -width 17

blt::tile::scrollbar .e.m.m.m.ybar \
    -orient vertical \
