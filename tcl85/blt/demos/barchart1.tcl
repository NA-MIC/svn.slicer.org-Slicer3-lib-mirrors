...
set normalBg [blt::bgstyle create gradient -low 0xFFFFFFFF -high 0x00000000]
...
source scripts/stipples.tcl
set bg [blt::bgstyle create gradient -high orange2 -low yellow2 \
	-dir y -jitter no -log no -relativeto self] 
