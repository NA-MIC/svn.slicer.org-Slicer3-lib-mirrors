...
blt::tile::scrollbar .b.m.xbar -orient horizontal -command { .b.m xview } \
    -width 17
# -elementborderwidth 2 -borderwidth 0
blt::tile::scrollbar .b.m.ybar -orient vertical -command { .b.m yview } \
...
blt::tile::scrollbar .b.m.m.xbar -orient horizontal -command { .b.m.m xview } \
    -width 17
# -elementborderwidth 2 -borderwidth 0
blt::tile::scrollbar .b.m.m.ybar -orient vertical -command { .b.m.m yview } \
    -highlightthickness 0 -width 17 
#-elementborderwidth 2 -borderwidth 0
...
blt::tile::scrollbar .b.m.m.m.xbar  \
    -orient horizontal \
    -command { .b.m.m.m xview } \
    -width 17

blt::tile::scrollbar .b.m.m.m.ybar \
    -orient vertical \
    -command { .b.m.m.m yview } \
    -highlightthickness 0 -width 17 

blt::tile::scrollbar .s -orient vertical -command { .b xview } 
