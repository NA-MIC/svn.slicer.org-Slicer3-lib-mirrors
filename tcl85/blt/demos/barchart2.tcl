...
blt::htext .header -text {
    %%
    blt::tile::radiobutton .header.stacked -text stacked -variable barMode \
    ...
    %% 
    blt::tile::radiobutton .header.aligned -text aligned -variable barMode \
    ...
    %%
    blt::tile::radiobutton .header.overlap -text "overlap" -variable barMode \
    ...
    %%
    blt::tile::radiobutton .header.normal -text "normal" -variable barMode \
...
set style [blt::bgstyle create picture -picture bgTexture]
