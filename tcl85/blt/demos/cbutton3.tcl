...
foreach {rgb name} $colors {
    ...
    $icon draw circle 11 11 8 -color 0x80000000
    $icon blur $icon 2
    $icon draw circle 11 11 9 -color \#$rgb -antialias yes
    $icon draw circle 11 11 9 -color black -thickness 1 -antialias yes
    #$icon draw circle 10 10 2 -color black -antialias yes
    .b.m add -label $name -icon $icon
}
