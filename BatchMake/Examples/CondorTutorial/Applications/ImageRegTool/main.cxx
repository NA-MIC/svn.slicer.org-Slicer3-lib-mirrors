...
int main(int argc, char **argv)
  ...
  if(argc > 1)
    ...
    command.AddField("FixedImage", "FixedImage Filename",
                     MetaCommand::STRING, true);
    command.AddField("MovingImage","MovingImage Filename",
                     MetaCommand::STRING, true);
