/*=========================================================================
  ...
  Program:   BatchMake
  Module:    $RCSfile: bmScriptCreateGraphAction.cxx,v $
  Language:  C++
...
/** */
ScriptCreateGraphAction::ScriptCreateGraphAction()
: ScriptAction()
{
}
...
/** */
bool ScriptCreateGraphAction::TestParam(ScriptError* error,int linenumber)
{
  if (m_Parameters.size()< 3)
    {
    error->SetError(MString("No enough parameter for CreateGraph"),linenumber);
    return false;
    }
...
/** */
MString ScriptCreateGraphAction::Help()
{
  return "CreateGraph(var 'Project Name' 'Experiment Name' [description])";
}

/** */
void ScriptCreateGraphAction::Execute()
{
