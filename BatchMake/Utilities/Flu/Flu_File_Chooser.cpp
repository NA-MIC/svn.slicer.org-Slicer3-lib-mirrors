// $Id: Flu_File_Chooser.cpp,v 1.2 2006/09/22 21:39:07 jjomier Exp $
...
Flu_File_Chooser :: Flu_File_Chooser( const char *pathname, const char *pat, int type, const char *title )
  : Fl_Double_Window( 600, 400, title ),
    filename( 70, h()-60, w()-70-85-10, 25, ""),
    ok( w()-90, h()-60, 85, 25 ),
...
void Flu_File_Chooser :: newFolderCB()
{
  ...
  Entry *entry = new Entry( newName.c_str(), ENTRY_DIR,isThisTrue, this );
  if( !fileDetailsBtn->value() )
    filelist->add( *entry );
  else
