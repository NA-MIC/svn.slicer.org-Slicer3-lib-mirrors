// $Id: Flu_File_Chooser.h,v 1.1 2006/09/07 02:18:34 jjomier Exp $
...
class FLU_EXPORT Flu_File_Chooser : public Fl_Double_Window
{
  ...
  class FileInput : public Fl_Input
    {
    public:
      FileInput( int x, int y, int w, int h, const char *l, Flu_File_Chooser *c = NULL);
      void SetChooser(Flu_File_Chooser * _chooser) {chooser = _chooser;}
      ~FileInput();
