...
# -*- tcl -*-
# Copyright (C) 2001 ActiveState Corporation May 05, 2004
#
# Extension code to tcl8.4/library/init.tcl declaring the
# version information for ActiveTcl.
#
# ActiveState ActiveTcl 8.4.6.1 Win32/x86, Wed May 05 1:34:37 PM Pacific Daylight Time 2004
#
...
namespace eval ::activestate {
	...
	maturity      {final}
	arch          {win32-ix86}
	buildtime,sec {1083789277}
	buildtime,fmt {Wed May 05 1:34:37 PM Pacific Daylight Time 2004}
	as,mode       {normal}
    }
    ...
    variable  config
    array set config {
	{ActiveTcl} {ActiveState ActiveTcl 8.4.6.1 Win32/x86, Build 99631 @ Wed May 05 1:34:37 PM Pacific Daylight Time 2004 / normal}
    }
}

package provide {ActiveTcl} {8.4.6.1}
