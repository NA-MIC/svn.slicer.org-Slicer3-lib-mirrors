...
#
# ActiveState ActiveTcl 8.5.10.1.295062 Win32/x86, Wed Jul 20 00:01:12 PDT 2011
#
...
namespace eval ::activestate {
	...
	maturity      {final}
	arch          {win32-ix86}
	buildtime,sec {1311145272}
	buildtime,fmt {Wed Jul 20 00:01:12 PDT 2011}
	as,mode       {normal}
    }
    ...
    variable  config
    array set config {
	{ActiveTcl} {ActiveState ActiveTcl 8.5.10.1.295062 Win32/x86 @ Wed Jul 20 00:01:12 PDT 2011 / normal}
    }
}

package provide {ActiveTcl} {8.5.10.1.295062}
