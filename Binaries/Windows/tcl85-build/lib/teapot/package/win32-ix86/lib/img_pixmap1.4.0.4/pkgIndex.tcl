...
# Meta description     This is support for the pixmap image format.
# Meta license         BSD
...
package ifneeded img::pixmap 1.4.0.4 [string map [list @ $dir] {
        ...
        # ACTIVESTATE TEAPOT-PKG END REQUIREMENTS
            ...
            load [file join {@} tkimgpixmap1404.dll]

        # ACTIVESTATE TEAPOT-PKG BEGIN DECLARE

        package provide img::pixmap 1.4.0.4
