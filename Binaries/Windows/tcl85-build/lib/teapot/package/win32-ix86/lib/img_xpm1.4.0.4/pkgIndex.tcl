...
# Meta description     This is support for the xpm image format.
# Meta license         BSD
...
# Meta require         {Tk 8.4}
# Meta subject         xpm
# Meta summary         xpm Image Support
# @@ Meta End


if {![package vsatisfies [package provide Tcl] 8.4]} return

package ifneeded img::xpm 1.4.0.4 [string map [list @ $dir] {
        ...
        # ACTIVESTATE TEAPOT-PKG END REQUIREMENTS
            ...
            load [file join {@} tkimgxpm1404.dll]

        # ACTIVESTATE TEAPOT-PKG BEGIN DECLARE

        package provide img::xpm 1.4.0.4
